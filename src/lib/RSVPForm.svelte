<script lang="ts">
    ...
    let guests: Guest[] = [];
    $: guests = Array.from({ length: partySize }, () => ({ firstName: '', lastName: '' }));
...
<h1>RSVP</h1>
<div id="desc">
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Zzril facer augue dolores consectetuer quod nonummy blandit molestie consectetur tincidunt consequat. Commodo nam duo adipisici incidunt, te odio duo doming at rebum aliquid enim excepteur, nisi wisi consectetur voluptua cum culpa vulputate sed eirmod ut delenit est.</p>
</div>
<section>
